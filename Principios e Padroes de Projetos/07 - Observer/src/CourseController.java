...
/**
 * Presents a given view of a set of courses and their marks. Uses the
 Observer
...
public class CourseController extends JPanel implements Observer,
    ...
    /**
     * Manages the creation of a new course. Called when the "New
     Course" button is pressed.
     *
     * @param arg0
     *            not used
     */
    public void actionPerformed(ActionEvent arg0) {
        String input = JOptionPane.showInputDialog("Please enter new ourse name:");
        if (input != null){
            courseData.addCourseRecord(new CourseRecord(input, 50));
            // leave it up notify/update mechanism to invokethis.addCourse
        }
    }

    /**
     * Handles the changing of the marks for a course (changing of a
     JSlider)
     *
     * @param arg0
    ...
    public void stateChanged(ChangeEvent arg0) {
        ...
        courseData.changeCourseRecord(slider.getName(),
                slider.getValue());
    }
    ...
    public static void main(String[] args) {
       ...
       BarChartObserver bar = new BarChartObserver(data);
        ...
        chartPanel.setLayout(new BoxLayout(chartPanel,
                BoxLayout.Y_AXIS));
        chartPanel.add(pie);
        chartPanel.add(bar);
